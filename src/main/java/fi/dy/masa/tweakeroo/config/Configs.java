...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigString        AFK_ACTION                          = new ConfigString      ("afkAction", "/disconnect", "tweakeroo.config.generic.comment.afkAction").translatedName("tweakeroo.config.generic.name.afkAction");
        public static final ConfigBoolean       AFK_IGNORE_INPUT                    = new ConfigBoolean     ("afkIgnoreInput", false, "tweakeroo.config.generic.comment.afkIgnoreInput").translatedName("tweakeroo.config.generic.name.afkIgnoreInput");
        public static final ConfigInteger       AFK_TIMEOUT                         = new ConfigInteger     ("afkTimeout", 2400, 200, 200000, "tweakeroo.config.generic.comment.afkTimeout").translatedName("tweakeroo.config.generic.name.afkTimeout");
        ...
        public static final ConfigBoolean       AREA_SELECTION_USE_ALL              = new ConfigBoolean     ("areaSelectionUseAll", false, "tweakeroo.config.generic.comment.areaSelectionUseAll").translatedName("tweakeroo.config.generic.name.areaSelectionUseAll");
        ...
        public static final ConfigInteger       CONTAINER_SCAN_MIN_ITEMS            = new ConfigInteger     ("containerScanMinItems", 1, 1, 100000, "tweakeroo.config.generic.comment.containerScanMinItems").translatedName("tweakeroo.config.generic.name.containerScanMinItems");
        public static final ConfigInteger       CONTAINER_SCAN_MIN_TYPES            = new ConfigInteger     ("containerScanMinTypes", 1, 1, 100000, "tweakeroo.config.generic.comment.containerScanMinTypes").translatedName("tweakeroo.config.generic.name.containerScanMinTypes");
        ...
        public static final ConfigInteger       DAY_CYCLE_OVERRIDE_TIME             = new ConfigInteger     ("dayCycleOverrideTime", 0, 0, 24000, "tweakeroo.config.generic.comment.dayCycleOverrideTime").translatedName("tweakeroo.config.generic.name.dayCycleOverrideTime");
        ...
        public static final ConfigBoolean       NOTE_EDIT_LETTERS                   = new ConfigBoolean     ("noteEditLetters", false, "tweakeroo.config.generic.comment.noteEditLetters").translatedName("tweakeroo.config.generic.name.noteEditLetters");
        public static final ConfigBoolean       NOTE_PLAY_KEY                       = new ConfigBoolean     ("notePlayKey", false, "tweakeroo.config.generic.comment.notePlayKey").translatedName("tweakeroo.config.generic.name.notePlayKey");
        public static final ConfigBoolean       NOTE_SCROLL                         = new ConfigBoolean     ("noteblockScroll", true, "tweakeroo.config.generic.comment.noteblockScroll").translatedName("tweakeroo.config.generic.name.noteblockScroll");
        ...
        public static final ConfigInteger       RESTRICTION_LAYER_HEIGHT            = new ConfigInteger     ("restrictionLayerHeight", 1, -1000, 1000, "tweakeroo.config.generic.comment.restrictionLayerHeight").translatedName("tweakeroo.config.generic.name.restrictionLayerHeight");
        public static final ConfigInteger       SCAFFOLD_PLACE_DISTANCE             = new ConfigInteger     ("scaffoldPlaceDistance", 5, 1, 20, "tweakeroo.config.generic.comment.scaffoldPlaceDistance").translatedName("tweakeroo.config.generic.name.scaffoldPlaceDistance");
        public static final ConfigBoolean       SCAFFOLD_PLACE_VANILLA              = new ConfigBoolean     ("scaffoldPlaceVanilla", false, "tweakeroo.config.generic.comment.scaffoldPlaceVanilla").translatedName("tweakeroo.config.generic.name.scaffoldPlaceVanilla");
        ...
        public static final ConfigBoolean       SELECTIVE_BLOCKS_HIDE_ENTITIES      = new ConfigBoolean     ("selectiveBlocksHideEntities", false, "tweakeroo.config.generic.comment.selectiveBlocksHideEntities").translatedName("tweakeroo.config.generic.name.selectiveBlocksHideEntities");
        public static final ConfigBoolean       SELECTIVE_BLOCKS_HIDE_PARTICLES     = new ConfigBoolean     ("selectiveBlocksHideParticles", true, "tweakeroo.config.generic.comment.selectiveBlocksHideParticles").translatedName("tweakeroo.config.generic.name.selectiveBlocksHideParticles");
        public static final ConfigBoolean       SELECTIVE_BLOCKS_NO_HIT             = new ConfigBoolean     ("selectiveBlocksNoHit", true, "tweakeroo.config.generic.comment.selectiveBlocksNoHit").translatedName("tweakeroo.config.generic.name.selectiveBlocksNoHit");
        public static final ConfigBoolean       SELECTIVE_BLOCKS_TRACK_PISTONS      = new ConfigBoolean     ("selectiveBlocksTrackPistons", false, "tweakeroo.config.generic.comment.selectiveBlocksTrackPistons").translatedName("tweakeroo.config.generic.name.selectiveBlocksTrackPistons");
        ...
        public static final ConfigOptionList    WEATHER_OVERRIDE_OPTION             = new ConfigOptionList  ("weatherOverrideOption", WeatherOverrideMode.CLEAR, "tweakeroo.config.generic.comment.weatherOverrideOption").translatedName("tweakeroo.config.generic.name.weatherOverrideOption");
    ...
    public static class Lists
    {
        ...
        public static final ConfigOptionList BLOCK_TYPE_RCLICK_RESTRICTION_MODE = new ConfigOptionList("blockTypeRClickRestrictionMode", ListType.NONE, "tweakeroo.config.lists.comment.blockTypeRClickRestrictionMode").translatedName("tweakeroo.config.lists.name.blockTypeRClickRestrictionMode");
        public static final ConfigStringList BLOCK_TYPE_RCLICK_WHITELIST        = new ConfigStringList("blockTypeRClickWhiteList", ImmutableList.of(), "tweakeroo.config.lists.comment.blockTypeRClickWhiteList").translatedName("tweakeroo.config.lists.name.blockTypeRClickWhiteList");
        public static final ConfigStringList BLOCK_TYPE_RCLICK_BLACKLIST        = new ConfigStringList("blockTypeRClickBlackList", ImmutableList.of(), "tweakeroo.config.lists.comment.blockTypeRClickBlackList").translatedName("tweakeroo.config.lists.name.blockTypeRClickBlackList");
        ...
        public static final ConfigOptionList SELECTIVE_BLOCKS_LIST_TYPE         = new ConfigOptionList("selectiveBlocksListType", ListType.NONE, "tweakeroo.config.lists.comment.selectiveBlocksListType").translatedName("tweakeroo.config.lists.name.selectiveBlocksListType");
        public static final ConfigString SELECTIVE_BLOCKS_WHITELIST             = new ConfigString("selectiveBlocksWhitelist", "", "tweakeroo.config.lists.comment.selectiveBlocksWhitelist").translatedName("tweakeroo.config.lists.name.selectiveBlocksWhitelist");
        public static final ConfigString SELECTIVE_BLOCKS_BLACKLIST             = new ConfigString("selectiveBlocksBlacklist", "", "tweakeroo.config.lists.comment.selectiveBlocksBlacklist").translatedName("tweakeroo.config.lists.name.selectiveBlocksBlacklist");
    ...
    public static class Disable
    {
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_CLIENT_BLOCK_EVENTS     = new ConfigBooleanHotkeyed("disableClientBlockEvents",             false, "", "tweakeroo.config.disable.comment.disableClientBlockEvents").translatedName("tweakeroo.config.disable.name.disableClientBlockEvents");
        public static final ConfigBooleanHotkeyed       DISABLE_CONTAINER_SCAN_OUTLINES = new ConfigBooleanHotkeyed("disableContainerScanOutlines",         false, "", "tweakeroo.config.disable.comment.disableContainerScanOutlines").translatedName("tweakeroo.config.disable.name.disableContainerScanOutlines");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_ITEM_ENTITY_RENDERING   = new ConfigBooleanHotkeyed("disableItemEntityRendering",           false, "", "tweakeroo.config.disable.comment.disableItemEntityRendering").translatedName("tweakeroo.config.disable.name.disableItemEntityRendering");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_LIVING_ENTITY_RENDERING = new ConfigBooleanHotkeyed("disableLivingEntityRendering",         false, "", "tweakeroo.config.disable.comment.disableLivingEntityRendering").translatedName("tweakeroo.config.disable.name.disableLivingEntityRendering");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_NAMETAGS                = new ConfigBooleanHotkeyed("disableNametags",                      false, "", "tweakeroo.config.disable.comment.disableMobSpawnerMobRendering").translatedName("tweakeroo.config.disable.name.disableMobSpawnerMobRendering");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_OTHER_PLAYER_RENDERING  = new ConfigBooleanHotkeyed("disableOtherPlayerRendering",          false, "", "tweakeroo.config.disable.comment.disableOtherPlayerRendering").translatedName("tweakeroo.config.disable.name.disableOtherPlayerRendering");
        public static final ConfigBooleanHotkeyed       DISABLE_PACKET_LIGHT_UPDATES    = new ConfigBooleanHotkeyed("disablePacketLightUpdates",            false, "", "tweakeroo.config.disable.comment.disablePacketLightUpdates").translatedName("tweakeroo.config.disable.name.disablePacketLightUpdates");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_PHANTOM_SPAWNING        = new ConfigBooleanClient  ("disablePhantomSpawning",               false, "", "tweakeroo.config.disable.comment.disablePhantomSpawning").translatedName("tweakeroo.config.disable.name.disablePhantomSpawning");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_STRUCTURE_RENDERING     = new ConfigBooleanHotkeyed("disableStructureRendering",            false, "", "tweakeroo.config.disable.comment.disableStatusEffectHud").translatedName("tweakeroo.config.disable.name.disableStatusEffectHud");
