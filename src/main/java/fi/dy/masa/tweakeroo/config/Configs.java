...
public class Configs implements IConfigHandler
{
    ...
    public static class Disable
    {
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_LIVING_ENTITY_RENDERING = new ConfigBooleanHotkeyed("disableLivingEntityRendering",         false, "", "Disables all living entity rendering (all entities with a health bar)");
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_ITEM_ENTITY_RENDERING   = new ConfigBooleanHotkeyed("disableItemEntityRendering",                 false, "", "Prevents all items from rendering");
