...
public class Hotkeys
{
    ...
    public static final ConfigHotkey FLEXIBLE_BLOCK_PLACEMENT_HOLD      = new ConfigHotkey("flexibleBlockPlacementHold",        "", KeybindSettings.RELEASE_ALLOW_EXTRA, "tweakeroo.config.hotkey.comment.flexibleBlockPlacementHold").translatedName("tweakeroo.config.hotkey.name.flexibleBlockPlacementHold");
    ...
    public static final ConfigHotkey AREA_SELECTION_OFFSET              = new ConfigHotkey("areaSelectionOffset",     "LEFT_SHIFT",     KeybindSettings.PRESS_ALLOWEXTRA, "tweakeroo.config.hotkey.comment.areaSelectionOffset").translatedName("tweakeroo.config.hotkey.name.areaSelectionOffset");
    public static final ConfigHotkey AREA_SELECTION_ADD_TO_LIST         = new ConfigHotkey("areaSelectionAddToList",            "",     KeybindSettings.PRESS_ALLOWEXTRA, "tweakeroo.config.hotkey.comment.areaSelectionAddToList").translatedName("tweakeroo.config.hotkey.name.areaSelectionAddToList");
    public static final ConfigHotkey AREA_SELECTION_REMOVE_FROM_LIST    = new ConfigHotkey("areaSelectionRemoveFromList",       "",     KeybindSettings.PRESS_ALLOWEXTRA, "tweakeroo.config.hotkey.comment.areaSelectionRemoveFromList").translatedName("tweakeroo.config.hotkey.name.areaSelectionRemoveFromList");
    public static final ConfigHotkey OPEN_ITEM_LIST                     = new ConfigHotkey("openItemList",                      "",     "tweakeroo.config.hotkey.comment.openItemList").translatedName("tweakeroo.config.hotkey.name.openItemList");
    public static final ConfigHotkey CONTAINER_SCANNER_CLEAR_CACHE      = new ConfigHotkey("containerScannerClearCache",        "",     "tweakeroo.config.hotkey.comment.containerScannerClearCache").translatedName("tweakeroo.config.hotkey.name.containerScannerClearCache");
    public static final ConfigHotkey NOTE_PLAY_KEY                      = new ConfigHotkey("notePlayKey",                       "",     "tweakeroo.config.hotkey.comment.notePlayKey").translatedName("tweakeroo.config.hotkey.name.notePlayKey");
