...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_PRECISE_COORDINATES       ("tweakPreciseCoordinates",             false, ""),
    ...
    TWEAK_RENDER_ALL_ENTITIES       ("tweakRenderAllEntities",              false, ""),
    ...
    STACK_FLEXIBLE                  ("stackFlexible",                       false, ""),
    ...
    TWEAK_DAY_CYCLE_OVERRIDE        ("tweakDayCycleOverride",               false, ""),
    TWEAK_WEATHER_OVERRIDE          ("tweakWeatherOverride",                false, ""),
    TWEAK_NO_SNEAK_SLOWDOWN         ("tweakNoSneakSlowdown",                     false, ""),
    TWEAK_SCAFFOLD_PLACE            ("tweakScaffoldPlace",                  false, ""),
    TWEAK_CONTAINER_SCAN            ("tweakContainerScan",                  false, ""),
    TWEAK_CONTAINER_SCAN_COUNTS     ("tweakContainerScanCounts",            false, ""),
    TWEAK_AFK_TIMEOUT               ("tweakAfkTimeout",                     false, ""),
    TWEAK_NOTEBLOCK_EDIT            ("tweakNoteblockEdit",                  false, ""),
    TWEAK_STANDARD_ASPECT_RATIO     ("tweakStandardAspectRatio",            false, "");
    ...
    FeatureToggle(String name, boolean defaultValue, String defaultHotkey)
    {
        this(name, defaultValue, false, defaultHotkey, KeybindSettings.DEFAULT,
                Reference.MOD_ID+".config.feature_toggle.comment."+name,
                Reference.MOD_ID+".config.feature_toggle.prettyName."+name,
                Reference.MOD_ID+".config.feature_toggle.name."+name);
    }
